    ...
    <>
      <div className=" h-auto md:max-w-5xl m-auto mt-20 ">
        <p className=" text-gray-400 pb-10">
          Questions? <span className="underline">Call 000-800-919-1743</span>
        </p>
        ...
        <div className=" h-auto md:max-w-5xl m-auto  flex flex-col md:flex-row p-4 ">
          <div className=" h-auto w-60  ">
            <li>
              ...
              <ul className="text-gray-400 pt-2 underline">
                Investor Relations
              </ul>
        ...
        <p className="text-gray-100 mt-10 text-sm p-4">Netflix India</p>

        <p className="text-gray-400 mt-10 text-sm p-4">
